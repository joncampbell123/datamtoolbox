...
//{
//	if (inFrame()) {
//		yfrau = (top.cP.indexOf(id)>0) ? true : false;
//	} else {
//		yfrau = (self==top && cP.indexOf(id)>0) ? true : false;
//	}
//	return yfrau;
//}
function writeAu()
{
	cnt='<iframe width=175 height=440 border=0 marginwidth=0 marginheight=0 hspace=10 vspace=0 frameborder=0 scrolling=no src=\"' + top.thGetOv + '?curl=' + top.thCanURL + '&sp=' + top.thSpaceId + '&IP=' + top.thIP + '&t=' + top.thTs + '&c=' + top.thCs + '\"></iframe>';
...
function isFrameset()
{
	isFr=(frames.length > 0)? true : false;
	return isFr; 
}
function divAu()
{
...
if (checkFrame()){
setTimeout ("minimizeAu('y_gc_div_au1')", 30000);
}
